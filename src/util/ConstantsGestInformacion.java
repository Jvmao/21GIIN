...
public class ConstantsGestInformacion {
	...
	/** The Constant labelTituloInformacion. */
	public final static String labelTituloInformacion = "Información";
	
	/** The Constant labelTipoConectado. */
	public final static String labelTipoConectado = "Tipo Usuario Conectado";
	
	/** The Constant labelInfoConv. */
	...
	public final static String imgInformacion = "/imagenes/info_64.png";
}
